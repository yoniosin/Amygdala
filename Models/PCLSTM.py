...
class PCLSTMCell(nn.Module):
    def __init__(self,  input_channels,  hidden_channels):
        ...
        create_gate = lambda: nn.Linear(self.input_channels * 2 + self.hidden_channels, self.hidden_channels)
    ...
    def forward(self, x, h_prev, c_prev, transition=False):
        ...
        i_t = nn.Sigmoid()(gates_dict['input_gate'](stacked_inputs))
        c_opt = nn.Tanh()(gates_dict['update_gate'](stacked_inputs))
        o_t = nn.Sigmoid()(gates_dict['output_gate'](stacked_inputs))
