...
from Models.SingleTransform import ReconstructingModel
import json
...
def load_data_set(ds_type, load):
    ...
    ds = ds_type(Path('../Amygdala/data/3D'), md)
...
if __name__ == '__main__':
    ...
    load_model = True
    train_dl, test_dl, input_shape = load_data_set(AmygDataSet, load=load_model)
